Template.cumulative_projected_revenue.rendered = function () {
    ...
    console.log('Cumulative: ' + revenueByMonths);
    ...
    $(document).ready(function () {
        var ctx = document.getElementById('cumulative_projected_revenue').getContext("2d");
